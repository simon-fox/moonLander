...
MyGame = ig.Box2DGame.extend({
	...
	init: function() {
		...
		//spawn monster
		this.player = ig.game.getEntitiesByType( EntityMoonLander )[0];
	...
	draw: function() {
		...
		//drawing text
		this.font.draw( "Fuel: " + ig.game.getEntitiesByType(EntityMoonLander)[0].fuel , x - 150, y - 280, ig.Font.ALIGN.LEFT );	
	},
