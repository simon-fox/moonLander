...
EntityMoonLanderP2 = ig.Box2DEntity.extend({
	size: {x: 90, y:60},
	...
	createBody: function() {
		...
		jointDef.localAnchorA =  new Box2D.Common.Math.b2Vec2( -40 * Box2D.SCALE , 30 * Box2D.SCALE );
	    ...
	    //engine 2
	    this.engine2 = ig.game.spawnEntity( EntityEngine2 , this.pos.x , this.pos.y );
		var jointDef = new Box2D.Dynamics.Joints.b2RevoluteJointDef;
	    ...
	    //engine 3
	    this.engine3 = ig.game.spawnEntity( EntityEngine2 , this.pos.x , this.pos.y );
		var jointDef = new Box2D.Dynamics.Joints.b2RevoluteJointDef;

		jointDef.localAnchorA =  new Box2D.Common.Math.b2Vec2( 0 * Box2D.SCALE , -30 * Box2D.SCALE );
		jointDef.localAnchorB =  new Box2D.Common.Math.b2Vec2( 0 * Box2D.SCALE , 0 * Box2D.SCALE );
